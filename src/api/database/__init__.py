...
class Database:
    def __init__(self):
        ...
        self.cursor.execute("""CREATE TABLE IF NOT EXISTS hotkeys (
                id TEXT,
                hotkey TEXT
            )""")
    ...
    def update_playlists(self, data: dict):
        ...
        self.cursor.execute("DELETE FROM playlists") # Delete everything in playlists to update.

        self.cursor.executemany("INSERT INTO playlists (id, name) VALUES (?, ?)", records)
        self.db.commit()
